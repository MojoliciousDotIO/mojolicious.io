...
##### a. Prepare angular app to be deployed in mojolicious:
...
##### c. Modify ~/workspace/project/mojo_angular/mojo_angular_app/lib/MojoAngularApps.pm (full app module) to serve the angular app:
...
##### d. Run hypnotoad to see if angular page is served
...
### Growing app
A simple demo to show an api call to Mojolicious from angular and display in angular

#### 1. Create a new route in Mojolicious App:

    Sachin@11:04 PM[~/workspace/project/mojo_angular/mojo_angular_app]$ cat lib/MojoAngularApp.pm 
    package MojoAngularApp;
    use Mojo::Base 'Mojolicious';
    ...
    sub startup {
        ...
        # AppName/Contorller/SomeModule.pm. This is just for quick demo.
...
Please note that http get route to advent/2018/detail is added.

#### 2. In Angular side make following changes:
##### a. Include the HttpClient Module which is required to make http request later. We need to include the module into the app.module.ts file.
...
##### b. Makign http request and binding data to adventDetail2018:
...
##### c. Modify app.componet.html file to show data fetched from backend Mojolicious
